...
{
    Super::DrawHUD();
    FString TestHUDString = FString(TEXT("Moving Backward"));
    FString String2 = FString(TEXT("Moving Forward"));
    DrawRect(FLinearColor::White, 500, 14, 400, 70);
    DrawRect(FLinearColor::White, 980, 14, 400, 70);
    DrawText(TestHUDString, FLinearColor::Black, 180, 10, GEngine->GetSubtitleFont(), 3.0, true);
    DrawText(String2, FLinearColor::Black, 350, 10, GEngine->GetSubtitleFont(), 3.0, true);
    //DrawText(TestHUDString, FLinearColor::White, 120, 120, GEngine->GetSubtitleFont(), 2.0, true);
